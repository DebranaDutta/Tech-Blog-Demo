...
public class Posts {
	...
	public Posts(String pTitle, String pContent, String pCode, String pPic, Timestamp pDate) {
		super();
		this.pTitle = pTitle;
	...
	public Posts(int pid, String pTitle, String pContent, String pCode, String pPic, Timestamp pDate) {
		super();
		this.pid = pid;
		this.pTitle = pTitle;
		this.pContent = pContent;
	...
	public String toString() {
		return "Posts [pid=" + pid + ", pTitle=" + pTitle + ", pContent=" + pContent + ", pCode=" + pCode + ", pPic=" + pPic + ", pDate=" + pDate
																																+ ", catId=" + catId
																																+ ", userId=" + userId
																																+ "]";
	}
