		...
		<div class="jumbotron banner-background">
			<div class="container">
				...
				<p>Computer programming is the process of performing a
					...
					executable computer program. Programming involves tasks such as
					analysis, generating algorithms, profiling algorithms' accuracy and
					resource consumption, and the implementation of algorithms</p>
				<p>Different programming languages support different styles of
					programming. The choice of language used is subject to many
					considerations, such as company policy, suitability to task,
					availability of third-party packages, or individual preference.</p>
				<button class="btn btn-outline-light primary-background btn-lg">
					<span class="fa fa-external-link"></span>Start ! it's free
				</button>
				<a href="Login_Page.jsp" class="btn btn-outline-light primary-background btn-lg">
